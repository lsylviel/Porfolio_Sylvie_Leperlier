document.addEventListener('DOMContentLoaded', () => {
            ...
            visualContent = `
                <div class="process-grid">
                    <div>
                        ...
                        <img src="${imgLow}" style="width:100%; display:block; border:4px solid black; box-shadow:5px 5px 0 black;">
                    </div>
                    <div>
                        <p style="font-family:'Bangers';text-align:center;margin-bottom:8px;">DESIGN FINAL (HAUTE-FI)</p>
                        <img src="${imgHigh}" style="width:100%; display:block; border:4px solid black; box-shadow:5px 5px 0 black;">
                    </div>
                </div>`;
        } else if (imgSingle) {
            visualContent = `<img src="${imgSingle}" style="width:100%; display:block; border:4px solid black; margin-bottom:20px; box-shadow:10px 10px 0 black;">`;
        }

        modalBody.innerHTML = `
            ${visualContent}
            <p style="font-size: 1.2rem; margin-top: 15px; margin-bottom: 30px; line-height:1.6; font-weight: 400;">${info}</p>
    ...
    document.querySelectorAll('.project-card-green').forEach(card => {
